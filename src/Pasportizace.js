...
function Pasportizace() {
  ...
  useEffect(() => {
    document.title = 'Pasportizace zahrad, parků, městského mobiliáře | Drone Soft'
  }, []);

  return (
    
    <section className='offpage container mx-auto'>
      <h1 className='relative z-[2] my-4'>Pasportizace zahrad, parků, městského mobiliáře</h1>
